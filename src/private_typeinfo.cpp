                             ...
                             obj_type& adjustedPtr) const
{
    ...
    if (thrown_class_type == 0)
        return false;
    // bullet 2
    __dynamic_cast_info info = {thrown_class_type, 0, this, 0, this, -1, 0};
                               ...
                               obj_type& adjustedPtr) const
{
    ...
    if (thrown_class_type == 0)
        return false;
    __dynamic_cast_info info = {thrown_class_type, 0, catch_class_type, 0, catch_class_type, -1, 0};
    info.number_of_dst_type = 1;
    thrown_class_type->has_unambiguous_public_base(&info, adjustedPtr, public_path);
    if (info.path_dst_ptr_to_static_ptr == public_path)
    {
               ...
               std::ptrdiff_t src2dst_offset)
{
    ...
    __dynamic_cast_info info = {dst_type, static_ptr, static_type, dynamic_ptr, dynamic_type, src2dst_offset, 0};
